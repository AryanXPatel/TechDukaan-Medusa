...
const sessionEnvVars = [
  "SESSION_SECRET=" +
    (process.env.COOKIE_SECRET || "eb57634bf9dd7338a655b17adf17c156"),
...
console.log(
  "3. On Azure VM: docker-compose -f docker-compose.production.yml down && docker-compose -f docker-compose.production.yml up -d"
);
